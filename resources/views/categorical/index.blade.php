                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Dihitung otomatis: nominal ini × (jumlah hari masuk karyawan - jumlah hari telat).</div>
                        </div>
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                ...
                                <input type="number" min="0" name="tenure_months_threshold" class="form-control"
                                    value="{{ old('tenure_months_threshold', $setting['tenure_months_threshold'] ?? 6) }}"
                                    required>
                            </div>
                            <div class="col-6">
                        ...
                        <label class="form-label fw-semibold">Tarif Lembur (Flat per Tier)</label>
                        <div class="row g-2">
                            <div class="col-4">
                                <label class="form-label small text-muted">1-2 Jam (Rp)</label>
                                <input type="number" min="0" name="lembur_1_2_jam" class="form-control"
                                    value="{{ old('lembur_1_2_jam', $setting['lembur_1_2_jam'] ?? 20000) }}" required>
                            </div>
                            <div class="col-4">
                                <label class="form-label small text-muted">3-4 Jam (Rp)</label>
                                <input type="number" min="0" name="lembur_3_4_jam" class="form-control"
                                    value="{{ old('lembur_3_4_jam', $setting['lembur_3_4_jam'] ?? 35000) }}" required>
                            </div>
                            <div class="col-4">
                                <label class="form-label small text-muted">5 Jam / Maks (Rp)</label>
                                <input type="number" min="0" name="lembur_5_jam" class="form-control"
                                    value="{{ old('lembur_5_jam', $setting['lembur_5_jam'] ?? 40000) }}" required>
                            </div>
                        </div>
                        <div class="form-text">
                            Nominal flat sesuai jam lembur (bukan dikali jam). Maksimal lembur yang bisa diinput adalah 5
                            jam.
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-text">Masing-masing rate dikali jumlah hari kehadiran pada kategori tersebut.
                        </div>
                    </div>
                </div>
            </div>
