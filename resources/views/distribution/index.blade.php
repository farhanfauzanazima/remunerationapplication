...
<form action="{{ route('distribution.send-bulk') }}" method="POST" id="distributionForm">
    ...
    <div class="card mb-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <button type="button" id="btnPilihSemua" class="btn btn-sm btn-outline-secondary">Pilih Semua</button>
                <button type="button" id="btnBatalSemua" class="btn btn-sm btn-outline-secondary">Batal Semua</button>
            </div>
        </div>
        <div class="card-body table-responsive">
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr><td colspan="5" class="text-center text-muted">Belum ada slip gaji untuk periode & cabang ini</td></tr>
                    @endif
                </tbody>
            </table>
        </div>
