        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center gap-3 mb-3">
                    <div style="width:52px;height:52px;border-radius:50%;background:var(--primary);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:20px;color:#212529;">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="w-100" style="font-size:15px;">
                    ...
                    <tr style="border-top:2px dashed #dee2e6;">
                        ...
                        <td class="py-3 text-end fw-700">
                            {{ rupiah(
                                ($slip['base_salary_amount'] ?? 0) +
                                ($slip['allowance_amount'] ?? 0) +
                                ($slip['bonus'] ?? 0)
                            ) }}
                        </td>
                    </tr>
                    ...
                    <tr style="border-top:3px solid var(--primary);background:#FFF3CD;">
                        ...
                        <td class="py-4 text-end fw-700 text-success"
                            style="padding-right:12px;font-size:22px;">
                ...
                <div class="d-flex gap-2 mt-4 flex-wrap">
                    <a href="{{ route('salary-slips.preview-pdf', $slip['id']) }}"
                       target="_blank"
                       class="btn btn-outline-secondary fw-600">
                        <i class="bi bi-eye me-2"></i>Preview PDF
                    </a>
                    <a href="{{ route('salary-slips.download-pdf', $slip['id']) }}"
                       class="btn btn-danger fw-600">
                        <i class="bi bi-file-pdf me-2"></i>Download PDF
                    </a>
                    <a href="{{ route('emails.send', $slip['id']) }}"
                       class="btn btn-success fw-600"
                       onclick="return confirm('Kirim slip gaji ke {{ $slip['employee']['email'] ?? '' }}?')">
